...
function registerGenerators (Blockly) {
    ...
    Blockly.Arduino.mpu6050_calibrate = function () {
        return `myIMU.calibrate();\n`;
    };

    Blockly.Arduino.mpu6050_updateYaw= function () {
        return `myIMU.update();\n`;
    };

    Blockly.Arduino.mpu6050_getYaw = function () {
        return [`myIMU.getYaw()`, Blockly.Arduino.ORDER_ATOMIC];
    };
