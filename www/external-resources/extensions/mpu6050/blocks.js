...
function registerBlocks (Blockly) {
    ...
    Blockly.Blocks.mpu6050_calibrate = {
        init: function () {
            this.jsonInit({
                message0: Blockly.Msg.MPU6050_CALIBRATE,
                colour: color,
                secondaryColour: secondaryColour,
                extensions: ['shape_statement']
            });
    ...
    Blockly.Blocks.mpu6050_updateYaw = {
        init: function () {
            this.jsonInit({
                message0: Blockly.Msg.MPU6050_UPDATEYAW,
                colour: color,
                secondaryColour: secondaryColour,
                extensions: ['shape_statement']
            });
        ...
        Blockly.Blocks.mpu6050_getYaw = {
        init: function () {
            this.jsonInit({
                message0: Blockly.Msg.MPU6050_GETYAW,
                colour: color,
                secondaryColour: secondaryColour,
                extensions: ['output_number']
            });
